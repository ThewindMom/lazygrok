...
describe("codex PostToolUse hook", () => {
	it("#given legacy CODEX_HOME #when building the daemon request context #then Grok and legacy config paths are exact", () => {
		...
		expect(context).toEqual({
			...
			projectConfigPaths: [
				path.join(realpathSync(cwd), ".grok", "lsp-client.json"),
